...
from digital_ic_agent._runtime.agent_async_fifo_render import AsyncFifoRenderMixin
from digital_ic_agent._runtime.agent_async_fifo_reports import AsyncFifoReportMixin
from digital_ic_agent._runtime.agent_async_fifo_runtime import AsyncFifoRuntimeMixin
...
class AsyncFifoPlugin(
    ...
    def __init__(self, target_name: str, services: PluginServices):
        ...
        self.project_root = source_root if (source_root / ".trae").is_dir() else package_dir
