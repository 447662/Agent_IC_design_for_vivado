...
- [ ] Copy the reviewed config to `src/digital_ic_agent/_runtime/targets/{module_name}.json`.
...
2. Copy `target/{module_name}.json` to
   `src/digital_ic_agent/_runtime/targets/{module_name}.json`.
3. Add the handler module under `src/digital_ic_agent/_runtime/target_handlers/`.
