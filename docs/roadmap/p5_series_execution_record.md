...
后续建议按 P5.11、P5.12 的顺序推进。未完成规划集中记录在 `docs/roadmap/project_followup_backlog.md`，后续继续设计时以该 backlog 作为入口，再结合 `p4_future_upgrade_roadmap.md` 和 `p5_general_digital_ic_agent_design.md` 细化任务。
