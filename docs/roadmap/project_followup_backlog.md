...
1. **P4.2**：将低覆盖项映射到 `scenario_catalog`，输出可执行补测建议。
2. **P4.3**：为 Total/Line/Branch/Condition/Toggle/Functional coverage 增加独立 gate。
3. **P4.4**：记录 coverage 历史与趋势，为回归和 gate 提供变化证据。
