...
1. **P4.3**：为 Total/Line/Branch/Condition/Toggle/Functional coverage 增加独立 gate。
2. **P4.4**：记录 coverage 历史与趋势，为回归和 gate 提供变化证据。
3. **P4.5**：归档失败 seed、日志、WDB、coverage DB 和可复现命令。
