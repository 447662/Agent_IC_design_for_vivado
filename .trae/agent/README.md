...
- P4.0-P4.7 已全部完成：coverage closure 看板、xcrg 低覆盖项提取、`scenario_catalog` 补测建议、分项 gate、coverage 历史趋势、失败 seed 自动归档、GUI 可见性自动验收和多 target 工程 dashboard 均已落地；下一步进入 P4 收尾复核。
